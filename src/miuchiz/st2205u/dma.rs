...
pub fn write_dptrl<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>, val: u8) {
...
pub fn write_dptrh<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>, val: u8) {
...
pub fn write_dbkrl<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>, val: u8) {
...
pub fn write_dbkrh<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>, val: u8) {
...
pub fn write_dcntl<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>, val: u8) {
    // println!("Write dcntl {val:02X}");
    st2205u.dma.dcnt.set_l(val);
}

pub fn write_dcnth<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>, val: u8) {
    // println!("Write dcnth {val:02X}");
    st2205u.dma.dcnt.set_h(val);
    execute_dma(st2205u);
}

pub fn write_dsel<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>, val: u8) {
    // println!("Write dsel {val:02X}");
    st2205u.dma.dsel.set(val);
}

pub fn write_dmod<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>, val: u8) {
    // println!("Write dmod {val:02X}");
    st2205u.dma.dmod.set(val);
}

pub fn read_dptrl<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>) -> u8 {
    // println!("Read dptrl");
    let dma = &mut st2205u.dma;
    match dma.get_ptr_selection() {
...
pub fn read_dptrh<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>) -> u8 {
    // println!("Read dptrh");
    let dma = &mut st2205u.dma;
    match dma.get_ptr_selection() {
...
pub fn read_dbkrl<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>) -> u8 {
    // println!("Read dbkrl");
    let dma = &mut st2205u.dma;
    match dma.get_ptr_selection() {
...
pub fn read_dbkrh<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>) -> u8 {
    // println!("Read dbkrh");
    let dma = &mut st2205u.dma;
    match dma.get_ptr_selection() {
...
pub fn read_dcntl<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>) -> u8 {
    // println!("Read dcntl");
    st2205u.dma.dcnt.l()
}

pub fn read_dcnth<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>) -> u8 {
    // println!("Read dcnth");
    st2205u.dma.dcnt.h()
}

pub fn read_dsel<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>) -> u8 {
    // println!("Read dsel");
    st2205u.dma.dsel.get()
}

pub fn read_dmod<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>) -> u8 {
    // println!("Read dmod");
    st2205u.dma.dmod.get()
}

fn execute_dma<M: AddressSpace>(st2205u: &mut St2205uAddressSpace<M>) {
